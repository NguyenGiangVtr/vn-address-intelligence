...
## **5.4 Kiểm thửnhất quán dữliệu lineage (Audit Bridge)**
...
_5.4._ _KIỂM THỬNHẤT QUÁN DỮLIỆU LINEAGE (AUDIT BRIDGE)_
...
### **5.4.3 Ý nghĩa đối với đánh giá AI end-to-end**
...
_5.5._ _KHUNG THỰC NGHIỆM SUPA-BENCH_

## **5.5 Khung thực nghiệm SUPA-Bench**

### **5.5.1 Kịch bản đánh giá cơ bản**
...
### **5.5.2 Diễn giải khoa học và giới hạn của kịch bản oracle**
...
### **5.5.3 Thực nghiệm phân tầng với kiểm chứng chéo K = 5**
...
## **5.6 Đánh giá Truy xuất Ngữnghĩa**
...
## **5.7 Kịch bản đánh giá End-to-End trên địa chỉthực tế**
...
## **5.8 Tối ưu hoá vận hành và đo lường hiệu năng**
...
## **5.9 Tác động Nghiệp vụvà Phân tích Rủi ro**
...
_≈_ 93 _._ 76 % — vượt mức tham khảo trong các nghiên cứu trước tại Việt Nam (Chương 2). **Ablation study
